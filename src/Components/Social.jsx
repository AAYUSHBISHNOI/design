  ...
  return (
    <div className=' my-10 lg:my-24 xl:my-[150px]'>
        <div className=' container max-w-[1164px] mx-auto px-3'>
          <h2 className=' text-black text-[36px] md:text-[48px] font-semibold ff_gilroy_heavy text-center line_height'>Social Proof</h2>
          <div className=' mt-2 lg:mt-[55px] flex flex-wrap justify-center lg:justify-between items-center text-center lg:text-start'>
            <div>
          ...
          <div className=' w-[100%] shadow-card flex flex-col sm:flex-row py-[30px] md:py-[44px] px-[45px] bg-white justify-between xl:justify-center items-center rounded-[16px] mt-[40px]'>
          ...
          {/* <div className=' w-[100%] shadow-card flex flex-wrap py-[30px] md:py-[44px] px-[45px] bg-white justify-between lg:justify-center items-center rounded-[16px] mt-[40px]'>
           <div className=' flex flex-col justify-between items-center md:mr-[76px]'>
           <Bulb/>
            <p className=' text-black text-[38px] font-semibold ff_gilroy_heavy line_height mt-2 md:mt-[24px]'>543+</p>
            <p className=' text-black text-[24px] font-semibold ff_gilroy_heavy line_height opacity-[0.9]'>Our Clients</p>
           </div>
           <Line/>
           <div className=' flex flex-col items-center  md:mx-[59px]'>
           <Network/>
            <p className=' text-black text-[38px] font-semibold ff_gilroy_heavy line_height mt-2 md:mt-[24px]'>154+</p>
            <p className=' text-black text-[24px] font-semibold ff_gilroy_heavy line_height opacity-[0.9]'>Global Brands</p>
           </div>
           <Line/>
           <div className=' flex flex-col items-center mt-10 md:mt-0 md:mx-[31px]'>
           <People/>
            <p className=' text-black text-[38px] font-semibold ff_gilroy_heavy line_height mt-2 md:mt-[24px]'>743+</p>
            <p className=' text-black text-[24px] font-semibold ff_gilroy_heavy line_height opacity-[0.9]'>Customer Solutions</p>
           </div>
           <Line/>
           <div className=' flex flex-col items-center mt-10 xl:mt-0 md:ml-[28px]'>
           <Twomem/>
            <p className=' text-black text-[38px] font-semibold ff_gilroy_heavy line_height mt-2 md:mt-[24px]'>343+</p>
