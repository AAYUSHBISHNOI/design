...
const Consectetur = () => {
  return (
    <div id="AboutUs" className="bg-black xl:pt-[60px]   lg:pb-[200px] md:py-[60px] lg:pt-[85px] py-[45px]  relative overflow-hidden">
      ...
      <div className="container max-w-[1144px] mx-auto px-3 md:px-[20px]" data-aos="fade-right">
        <h2 className="xl:text-[48px] lg:text-[44px] text-[30px] md:text-[40px] font-semibold ff_semi_bold text-white text-center leading-[118%]">
          Lorem ipsum dolor amet{" "}
          <span className="block massa_clr">consectetur Interdum</span>
        </h2>
        <div className="flex flex-wrap xl:justify-between justify-center md:gap-7  lg:gap-0 mt-[20px] sm:mt-20 sm:pb-16 md:mt-16 lg:mt-[60px] items-center">
