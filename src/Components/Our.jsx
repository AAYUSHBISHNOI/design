...
const Our = () => {
  return (
    <div id='Portfolio' className=' bg-[#000] relative overflow-hidden z-50'>
        ...
        <div className=' container max-w-[1164px] mx-auto pt-[34px] md:pt-[34px] pb-10 md:pb-[86px] px-3 lg:px-6 xl:px-3'>
           <div className=' flex flex-col lg:flex-row text-center lg:text-start justify-center lg:justify-between items-center ' data-aos="fade-right">
            <div>
                ...
                <h2 className=' text-white mt-1 md:mt-[16px] ff_gilroy_heavy font-semibold text-[30px] md:text-[48px] line_height'>Take a look our work</h2>
                <p className=' text-[#e5e5e5] leading-[150%] mt-1 lg:mt-[16px] ff_inter text-[14px] md:text-[16px] font-normal opacity-[0.9]'>Lorem ipsum dolor sit amet consectetur. Interdum neque arcu massa eleifend. <span className=' md:block'> Vulputate nisl est mollis bibendum egestas diam pellentesque felis.</span></p>
            </div>
           ...
           <div className='grid gap-[23px] md:grid-cols-2 grid-rows-1 mt-7 lg:mt-[55px]'>
