...
const Our = () => {
  return (
    <div id='Portfolio' className=' bg-[#000] relative'>
        ...
        <div className=' container max-w-[1164px] mx-auto py-[40px] md:py-[61px] px-3'>
           <div className=' flex flex-wrap text-center lg:text-start justify-center lg:justify-between items-center mb-10 md:mb-[69px]' data-aos="fade-right">
            <div>
