...
export const LoremIpsum = () => {
  return (
    <div className="xl:py-[150px] py-[50px] lg:py-[60px]">
      <div className="container  max-w-[1164px] mx-auto px-3">
        <h2 className="lg:text-[48px] text-[30px] sm:text-[40px] ff_semi_bold font-semibold text-center leading-[119%]">
        ...
        <div className="flex flex-wrap lg:justify-between justify-center items-center lg:mt-[55px] mt-[30px]">
          <div className="lg:w-[32%] md:w-[45%] sm:w-[100%] cursor-pointer  flex justify-center ">
          ...
          <div className=" lg:w-[32%] md:w-[45%] sm:w-[100%] cursor-pointer flex justify-center mt-[30px] md:mt-0">
            <div className="md:w-[93%] w-[100%] lg:w-[100%] max-w-[364px] card_border_gradient py-[44px] px-[24px] rounded-[16px]">
              <Materials />
              <p className="text-[24px] font-semibold ff_semi_bold text-black leading-[normal] mt-[35px]">
                Lorem ipsum dolor sit amet consectetur.
          ...
          <div className="lg:w-[32%] md:w-[45%] sm:w-[100%] cursor-pointer flex justify-center md:mt-[25px] mt-[30px] lg:mt-0">
            <div className="md:w-[93%] w-[100%] lg:w-[100%] max-w-[364px] card_border_gradient py-[44px] px-[24px] rounded-[16px]">
              <Massage />
              <p className="text-[24px] font-semibold ff_semi_bold text-black leading-[normal] mt-[35px]">
                Lorem ipsum dolor sit amet consectetur.
