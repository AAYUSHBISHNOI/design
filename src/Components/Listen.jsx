      ...
      <div className=' container max-w-[1164px] mx-auto pt-[45px] md:pt-[60px] lg:pt-[85px] xl:pt-[150px] px-3 md:px-[20px]'>
        ...
        <h2 className=' text-black ff_gilroy_heavy text-[28px] xl:text-[48px] md:text-[36px] lg:text-[44px]   font-semibold line_height mt-2 md:mt-[16px]'>Listen to our happy clients</h2>
          ...
          <div className=' mt-3 md:mt-0'>
              ...
              <button className=' rotate-180 z-3' onClick={() => slider.current.slickNext()}><Arrowone/></button>
        </div>
        </div>
       ...
       <Slider ref={slider} {...settings} className='lg:mt-[45px] mt-[20px]'>
        <div className=''>
          ...
          <div className='  items-center gap-[30px] lg:gap-[10px] xl:gap-[30px] flex flex-col justify-center md:justify-start md:flex-row'>
            ...
            <div className=' flex flex-col justify-center text-center items-center md:justify-start md:items-start md:text-start'>
              ...
              <p className='txt_clr_1 ff_lato text-[16px] lg:text-[13px] xl:text-[15px] xxl:text-[16px] font-normal leading-[150%] my-[10px] md:my-[16px]'>Lorem ipsum dolor sit amet, consectetur adipiscing <span className=' lg:block'>elit. Cursus nibh mauris, nec turpis orci lectus. </span></p>
              <Fivestar/>
            </div>
          </div>
          </div> 
            </div>
            <div className='w-[100%] lg:w-[50%] hidden lg:block' data-aos="zoom-in-down">
            <div className='card_shadow hover:text-white  py-[25px] px-[23px] rounded-[13px] card_radius card_bg z-50'>
          <div className=' lg:flex items-center gap-[30px] lg:gap-[10px] xl:gap-[30px] flex flex-col justify-center md:justify-start md:flex-row'>
            <div className=' relative'>
            <Elps/>
              <img className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]' src={girl} alt="" />
            </div>
            <div className='flex flex-col justify-center text-center items-center md:justify-start md:items-start md:text-start'>
              <p className='  ff_gilroy_heavy line_height font-semibold text-[24px]'>Latifa Alghanim</p>
              <p className='txt_clr_1 ff_lato text-[16px] lg:text-[13px] xl:text-[15px] xxl:text-[16px] font-normal leading-[150%] my-[16px]'>Lorem ipsum dolor sit amet, consectetur adipiscing <span className=' lg:block'>elit. Cursus nibh mauris, nec turpis orci lectus. </span></p>
              <Fourstar/>
            </div>
          </div>
          </div> 
          ...
          <div className=' flex  gap-[25px] mt-[24px]'>
            <div className='w-[100%] lg:w-[50%]' data-aos="zoom-out">
            <div className='card_shadow hover:text-white  py-[25px] px-[23px] rounded-[13px] card_radius card_bg z-50'>
          <div className=' flex flex-col items-center md:flex-row gap-[30px] lg:gap-[10px] xl:gap-[30px]'>
            <div className=' relative '>
            <Elps/>
              <img className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]' src={girl} alt="" />
            </div>
            ...
            <div className='w-[100%] lg:w-[50%] hidden lg:block'  data-aos="zoom-out-up">
            <div className='card_shadow hover:text-white  py-[25px] px-[23px] rounded-[13px] card_radius card_bg z-50'>
          <div className=' lg:flex items-center gap-[30px] lg:gap-[10px] xl:gap-[30px]'>
            <div className=' relative'>
            <Elps/>
              <img className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]' src={girl} alt="" />
          ...
          <div className='flex  gap-[25px]'>
            <div className='w-[100%] lg:w-[50%]' data-aos="zoom-in">
            <div className='card_shadow hover:text-white  py-[25px] px-[23px] rounded-[13px] card_radius card_bg z-50'>
          <div className='flex flex-col md:flex-row items-center gap-[30px] lg:gap-[10px] xl:gap-[30px]'>
            <div className=' relative '>
            <Elps/>
              <img className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]' src={girl} alt="" />
            ...
            <div className='w-[100%] lg:w-[50%] hidden lg:block' data-aos="zoom-in-up">
            <div className='card_shadow hover:text-white  py-[25px] px-[23px] rounded-[13px] card_radius card_bg z-50'>
          <div className=' lg:flex items-center gap-[30px] lg:gap-[10px] xl:gap-[30px]'>
            <div className=' relative'>
            <Elps/>
          ...
          <div className='flex  gap-[25px] mt-[24px]'>
            <div className='w-[100%] lg:w-[50%]' data-aos="zoom-out">
            <div className='card_shadow hover:text-white  py-[25px] px-[23px] rounded-[13px] card_radius card_bg z-50'>
          <div className='flex flex-col md:flex-row items-center md:items-start gap-[30px] lg:gap-[10px] xl:gap-[30px]'>
            <div className=' relative'>
            <Elps/>
              <img className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]' src={girl} alt="" />
            </div>
